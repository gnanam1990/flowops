...
var runtimeTables = []tableContract{
	...
	{name: "ascp_agent_signer_bindings", allowed: set("SELECT", "INSERT", "UPDATE")},
	{name: "ascp_agent_signer_binding_history", allowed: set("SELECT", "INSERT")},
	{name: "ascp_agent_signer_binding_changes", allowed: set("SELECT", "INSERT")},
...
var runtimeColumnUpdates = []columnUpdateContract{
	...
	{table: "ascp_proposal_workflows", columns: set("state", "approved_by", "approver_role", "approver_step_up_at", "approver_step_up_until", "approved_at", "cancelled_by", "cancelled_at", "expired_at", "submission_transaction_hash", "submitted_at", "confirmed_at", "completion_receipt", "completion_digest", "completed_at", "terminal_reason", "terminal_at")},
