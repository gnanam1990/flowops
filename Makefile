...
check: fmt-check solidity-fmt-check test-deployment-evidence test-mainnet-readiness test-mainnet-deployer-verification test-security-review-package smoke-rpc-admission dashboard-check
	go vet $(GO_PACKAGES)
	go test -race $(GO_PACKAGES)
	forge build --sizes
	forge test
