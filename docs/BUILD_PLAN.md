...
8. Base reconciliation and halt-safe state. **Continuous production observer wiring, durable quorum progress, receipt/finality worker, bounded reorg correction, and the manual operator gate are implemented; customer-signer broadcast registration, dedicated provider selection, and extended Sepolia threshold measurements remain external gates.**
