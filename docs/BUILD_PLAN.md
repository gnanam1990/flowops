...
- The dashboard control-plane adapter and server-side FlowOps organization membership check are not implemented; preview controls cannot move funds or mutate authorization state.
