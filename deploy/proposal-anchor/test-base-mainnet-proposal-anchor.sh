...
expect_rejected broadcast-disabled '.broadcastAuthorized = false'
...
printf 'proposal anchor package validator rejected all unsafe mutations; one-time broadcast is authorized\n'
