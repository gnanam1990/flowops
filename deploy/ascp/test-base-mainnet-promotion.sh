...
expect_rejected revoke-safe-finality '.safe.deploymentFinalized = false | .unresolved += ["safe-deployment-finality"]'
expect_rejected invent-finalized-block '.safe.finality.rpcObservations[1].finalizedBlock = .safe.deploymentBlock - 1'
