...
expect_rejected substitute-safe-owner '.safe.owners[0] = "0x1111111111111111111111111111111111111111"'
expect_rejected substitute-safe-runtime '.safe.runtimeCodeHash = "0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"'
expect_rejected substitute-safe-implementation '.safe.implementation = "0x1111111111111111111111111111111111111111"'
expect_rejected safe-nonce-drift '.safe.nonce = 1'
